...
def send_message():
    ...
    custom = 'Analyse the given message for a project"'+message['text']+'". Return the results in the following format (Polarity,Extracted Concern,Category,Intensity out of 10). Polarity=positive or negative, Extracted concern = text, Category examples: Anxious, depressed, hungry etc.Examples: "(Negative,constantly worried,Health Anxiety,4), (I feel happy and excited lately.,Positive,happy and excited,Depression,1)". Don\'t format or give a breakdown (only one tuple)';
